package profe.empleadosdpts.mvc.controllers;
...
import profe.empleadosdpts.negocio.EmpNegocio;
...
public class EmpleadosRestController {
	...
	@PostMapping("/dptos/{dptoId}")
	public void insertaEmpleadoYAsignaDepartamento(@PathVariable String dptoId, @RequestBody Empleado emp) {
			negocio.insertaEmpleadoYAsignaADpto(emp, dptoId);
	}
